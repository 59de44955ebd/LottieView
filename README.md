...
LottieView is based on [lottie-web](https://github.com/airbnb/lottie-web), uses [Microsoft Edge WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2) and is written in Python. It's a showcase app for WebView2 Python binding [WebView2-for-Python](https://github.com/59de44955ebd/webview2-for-python), and meant to demonstrate that you really don't always need yet another Chromium browser engine (wasting your disk space) for every webview-based desktop app. E.g. [LottiePlayer](https://www.lottieplayer.com/), based on Electron, has a compressed installer of 120 MB which expands to 428 MB disk space, whereas the LottieView installer only has 5.8 MB and expands to 20.2 MB.
